...
Основное действие до расчёта — «Построить план», после — «Событие дня». Верхние карточки отвечают на четыре вопроса: сколько заявок назначено, сколько специалистов нужно, какой пробег и сколько исключений осталось. Карта и список маршрутов работают совместно: выбор специалиста выделяет его маршрут, выбор точки открывает заявку. Переключение на расписание даёт контроль временных окон.
...
| Поддержка     | Проверить ресурсы и увидеть резерв             | Навыки/смена/транспорт, переход на карту |
